...
const LayerStructure: React.FC<LayerStructureProps> = ({
  ...
  const materials = {
    perovskite: [
      {
        value: "MAPbI3",
        label: `MAPbI₃ (${t.perovskiteLabel})`,
        color: "bg-red-100",
      },
      {
        value: "CsPbI3",
        label: `CsPbI₃ (${t.perovskiteLabel})`,
        color: "bg-red-200",
      },
    ],
    htl: [
  ...
  return (
    ...
    >
      ...
      <div className="space-y-3 text-center w-full max-w-sm relative">
        ...
        >
          <span className="font-medium">{t.transparentElectrode}</span>
        </motion.div>
        ...
        <motion.div
          ...
          whileHover={{ scale: 1.02 }}
        >
          <span className="font-medium">TiO₂ ({t.etlLabel})</span>
        </motion.div>
        ...
        <div className="relative">
          ...
          >
            <div className="flex items-center justify-center space-x-2">
              <span className="font-medium">
                {getCurrentLabel("htl", htl)} ({t.htlLabel})
              </span>
              <ChevronDown
                className={`w-4 h-4 transition-transform ${
        ...
        <motion.div
          ...
          whileHover={{ scale: 1.02 }}
        >
          <span className="font-medium">Au ({t.backElectrode})</span>
        </motion.div>
      </div>
